...
@Component
public class AbankDtoMapper {
    private final aBankAPI aBankApi;
    @Autowired
    public AbankDtoMapper(aBankAPI aBankApi) {
        this.aBankApi = aBankApi;
    }
    public CurrencyOnlineDTO parseCurrencyOnline() {
        String htmlPage = aBankApi.getCurrencyPage();
